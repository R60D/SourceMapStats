...
timeout_query = 0.5  # How long to wait for each individual server to respond during slow search
timeout_master = 60  # How long to wait for the master server to respond during slow search
...
IpcountList = 5 #How many maps to show at once in the writer.
FastWriteDelay = 10 #How often to run the FastWriter
